...
(function(root) {
  ...
  var defaults = {
    ...
    gasWebAppUrl: 'https://script.google.com/macros/s/AKfycbzT9SGoEElhaVUfV1bXjajnjsj22di5RaGjv-Ntil66CNrOQo_1F5k1l-B90t8aUCXM8g/exec',
    logoUrl: FALLBACK_LOGO,
    fallbackLogoUrl: FALLBACK_LOGO,
    localAssetBase: './partials/',
    localAssetBaseCandidates: ['./partials/', 'partials/', '../partials/'],
    transportMode: 'bridge-client-authenticated-read-p2-index',
