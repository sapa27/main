...
(function(root) {
  ...
  var defaults = {
    ...
    gasWebAppUrl: 'https://script.google.com/macros/s/AKfycbwSgyDJZNIgykDSUnM4EX1CC4dHeAr8WUEgf8aUkqJkz76QUJ2MH7Zxq-wEm0PREx3gKQ/exec',
    logoUrl: FALLBACK_LOGO,
    fallbackLogoUrl: FALLBACK_LOGO,
    localAssetBase: './partials/',
    localAssetBaseCandidates: ['./partials/', 'partials/', '../partials/'],
    transportMode: 'phase2-compact-single-owner-first-paint-lazy-bridge-read',
    phase1DataLoadingPerformance: true,
    phase2SingleSourceRefactor: true,
    phase2CanonicalPartialRoot: 'src/frontend/partials',
    ...
    releaseStamp: 'phase2-compact-single-owner-2026-07-01-r1',
