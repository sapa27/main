(function(root) {
    ...
    ,
    APP_RELEASE_STAMP = "commission-v1.2-github-pages-gas-direct-2026-07-14-r107",
    APP_ASSET_STAMP = "asset-manifest-commission-v1.2-github-pages-gas-direct-2026-07-14-r107",
    ...
    VERCEL_GAS_WEB_APP_URL = cleanUrl(GITHUB_DIRECT_CONFIG.gasWebAppUrl || GITHUB_DIRECT_CONFIG.GAS_WEB_APP_URL || root.GITHUB_GAS_WEB_APP_URL || root.GAS_WEB_APP_URL || STORED_GAS_WEB_APP_URL || "https://script.google.com/macros/s/AKfycbwThtAfnSn15rbQaY4grEEEa4hyQY8X0RRVFXIxeuyYnbQ_6SR0dt4Vy_fx-1rqOGMt/exec"),
    ...
    defaults = {
      ...
      localAssetBaseCandidates: ["./partials/",
        "partials/",
        "../partials/"],
      transportMode: "github-pages-gas-direct-bridge-primary",
      ...
      readJsonpApi: !0,
      authenticatedReadBridgeFirst: !0,
      ...
      legacyTransportRemoved: !1,
      legacyJsonpTransportRemoved: !1,
    ...
    root.APP_CONFIG.transportMode = "github-pages-gas-direct-bridge-primary";
    ...
    root.APP_CONFIG.legacyTransportRemoved = false;
    ...
    root.APP_CONFIG.authenticatedReadBridgeFirst = true;
    ...
    try {
      ...
      root.APP_CONFIG.transportMode = transport && /github-pages-gas-direct/i.test(transport)
        ? transport
        : "github-pages-gas-direct-bridge-primary";
    } catch (_configError) {
