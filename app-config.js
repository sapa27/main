...
(function(root) {
  ...
  var defaults = {
    ...
    gasWebAppUrl: 'https://script.google.com/macros/s/AKfycbw-tK2zSFK5uwqO6HMglYuvttDcUEP6Lj2uGNQLuOh-xxKSN19-691Y10WtpiGYQyYIkw/exec',
    ...
    fastLoginJsonp: true,
    loginFormPost: false,
    loginBridgeFallback: true,
    legacyActiveUserLoginFallback: true,
    loginPostTimeoutMs: 8000,
    fastLoginTimeoutMs: 15000,
    readJsonpApi: true,
    readJsonpFallbackToBridge: true,
    jsonpApiTimeoutMs: 15000,
    jsonpHealthCheck: true,
    jsonpHealthMethod: 'apiGetRouteContract',
    jsonpHealthTimeoutMs: 1500,
    jsonpDisableOnFirstFailure: true,
    jsonpLateCallbackTtlMs: 120000,
