(function(root) {
    ...
    ,
    APP_RELEASE_STAMP = "commission-v1.2-github-pages-gas-direct-2026-07-14-r97",
    APP_ASSET_STAMP = "asset-manifest-commission-v1.2-github-pages-gas-direct-2026-07-14-r97",
    ...
    VERCEL_GAS_WEB_APP_URL = cleanUrl(GITHUB_DIRECT_CONFIG.gasWebAppUrl || GITHUB_DIRECT_CONFIG.GAS_WEB_APP_URL || root.GITHUB_GAS_WEB_APP_URL || root.GAS_WEB_APP_URL || STORED_GAS_WEB_APP_URL || "https://script.google.com/macros/s/AKfycbyePJucr2k5kt5xvyOymbatxKIxEJf4pSYWjzeABKPHRjFwlWrmVMZuP7sw2mXWnx-f/exec"),
