...
function _apiGetPeoplePageBundleCore_(payload) {
  ...
  try {
    ...
    }), data.historyRows = data.historyRows || [], data.peopleProductionDto =! 0, data.peopleDtoOwner = "Code_33_Domain_People.apiGetPeoplePageBundle", data.contractStamp = "people-page-bundle-dto-ppl-current";
    try {
