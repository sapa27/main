# R108 GitHub Pages Data / Session Token Fix
...
4. อัปเดต release/cache bust เป็น `r108`
...
หลัง GitHub Pages deploy เสร็จ ให้ปิดแท็บเดิม เปิดหน้าใหม่ และกด `Ctrl+F5` หนึ่งครั้ง เพื่อให้โหลด asset stamp `r108`
...
## R108 — GitHub authenticated data transport correction
