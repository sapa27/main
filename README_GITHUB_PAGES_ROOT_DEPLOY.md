# GitHub Pages + Google Apps Script — R121

ชุด R121 ใช้ GAS Web App deployment ต่อไปนี้เป็น backend:
...
ไฟล์ JavaScript local ทั้งหมดต้องโหลดด้วย `?v=r121`
...
3. ตรวจ Network ให้ JavaScript local ทั้ง 7 ไฟล์เป็น `r121`
